...
@Stateless
@Path("/caseService")
public class CaseServiceAPIFacadeREST extends AbstractFacade<CaseService> {
    
    private ServiceMasterService service;

    public CaseServiceAPIFacadeREST() {
    ...
    @PUT
    @Path("/updateServiceStatus/{id}")
    @Consumes({MediaType.APPLICATION_JSON})
    public int edit(@HeaderParam("x-access-token") String jwt, @PathParam("id") Integer id, ServiceMaster entity) throws SQLException {
